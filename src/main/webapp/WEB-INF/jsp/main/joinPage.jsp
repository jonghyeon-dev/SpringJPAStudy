...
<body class="bg-light">
    <div class="container">
        <div>
            <form id="joinUserForm" method="post" action="<c:url value='/addUser.do'/>">
                ...
                <button class="btn btn-success" type="submit" id="addUser">등록</button>
            </form>
        <div>
    </div>
</body>
<script>
    var joinPage = (function(){
        var init = function(){
            console.log("Join Page Document Is Ready");
        };
